...
public class Multipart {
    public Multipart(String Address){this.Address = Address;}
    ...
    public Multipart append(String name, String data){
    ...
    public Multipart input_file(String Content_Type, String name, File file){
